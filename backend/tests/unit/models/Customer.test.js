...
describe('Customer Model', () => {
  const base = { name: 'Juan Pérez', phoneOrEmail: '+56912345678', password: 'password123' };
  ...
  test('accepts email as phoneOrEmail', async () => {
    const c = await Customer.create({ name: 'Ana', phoneOrEmail: 'ana@mail.com', password: 'password123' });
